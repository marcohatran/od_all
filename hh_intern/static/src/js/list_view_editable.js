odoo.define('hh_intern.ListEditor', function (require) {
"use strict";    
/*---------------------------------------------------------
...
ListViewNew.prototype.defaults.editable = null;

// TODO: not sure second @lends on existing item is correct, to check
ListViewNew.include(/** @lends instance.web.ListView# */{
    init: function () {
        var self = this;
            ...
            return self.with_event('save', {
                ...
                return self.editor.save().then(function (attrs) {
                    ...
                    return self.cancel_edition(true)
                        ...
                        .then(function () {
                            if(typeof record.attributes.id === 'string'){
...
//
//ListViewNew.Groups.include(/** @lends instance.web.ListView.Groups# */{
...
//});
//
//ListViewNew.List.include(/** @lends instance.web.ListView.List# */{
...
//var FormViewNew = FormView.extend({
//
//    _process_save: function(save_obj) {
//        var self = this;
//        var prepend_on_create = false;
